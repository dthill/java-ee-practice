...
If the user tries to access the landing page or the dashboard before he is logged in, a filter will stop him and redirect him to the login page. The login will also display an error message if applicable that was saved as a request attribute.
